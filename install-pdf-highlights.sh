...
mkdir -p /var/lib/pdf-highlights-venv
chown "$(whoami)" /var/lib/pdf-highlights-venv
virtualenv /var/lib/pdf-highlights-venv
...
deactivate
echo "export PATH=/var/lib/pdf-highlights/bin:\${PATH}" >> ${HOME}/.bash_profile
source ${HOME}/.bash_profile
sh -c "echo PATH=/var/lib/pdf-highlights/bin:\$PATH >> /etc/environment"
